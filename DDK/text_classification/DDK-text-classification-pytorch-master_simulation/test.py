...
def main(args, seed_id):
    ...
    if args.test_set:
        ...
        _, accuracy, precision, recall, f1, cm = evaluate(model, test_dataloader, args, noise_mean=0.20329, noise_std=1.14726, map_min=40, map_max=300)
        logger.info('-' * 50)
        logger.info(
...
if __name__ == "__main__":
    ...
    parser.add_argument("--model_save_path", type=str, default="/home/gaolili/deepLearning_project/DDK-text-classification-pytorch-master_simulation/model_saved_word_dim")
