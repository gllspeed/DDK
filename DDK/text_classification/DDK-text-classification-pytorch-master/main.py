...
def main(args, seed_id):
    ...
    train(model, optimizer, train_dataloader, valid_dataloader, args, seed_id)
...
if __name__ == "__main__":
    ...
    parser.add_argument("--model_save_path", type=str, default="/home/gaolili/deepLearning_project/DDK-text-classification-pytorch-master/model_saved")
