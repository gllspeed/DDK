...
if __name__ == "__main__":
    ...
    ttest_loader = torch.utils.data.DataLoader(
    ...
    for trial in ['3', '23', '26', '32', '47']:##########表示五组实验
        accuracy_path = os.path.join('/home/gaolili/deepLearning_project/mnist_classification_64_simulation/result/DDK_fc_bn_relu_fine_tuning',trial)
    ...
    print("accuracy_fusion_avg_all",accuracy_fusion_avg_all)
