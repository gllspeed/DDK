...
if __name__ == "__main__":
    for trial in range(1,6):
        ...
        for epoch in range(1, epochs + 1):
            ...
            print("alpha", model.DDK.alpha.cpu().detach().numpy()[0])
            print("beta", model.DDK.beta.cpu().detach().numpy()[0])
                ...
                if acc_best_epoch>=0.9:
                    if input_data_DDK:
                        torch.save(model.state_dict(),
                                   '/home/gaolili/deepLearning_project/mnist_classification_32/ckpt_32/mnist_' + str(trial)+'_'+ str(
                                       acc_best_epoch) + '.pt')
                    else:
                        torch.save(model.state_dict(),
                                   '/home/gaolili/deepLearning_project/mnist_classification_32/ckpt/mnist_' + str(trial)+'_'+ str(
                                       acc_best_epoch) + '.pt')
        ...
        np.savetxt(os.path.join('/home/gaolili/deepLearning_project/mnist_classification_32/result_32/DDK' ,str(trial), 'accuracy.txt'), test_accuracy, fmt='%.6f')
        np.savetxt(os.path.join('/home/gaolili/deepLearning_project/mnist_classification_32/result_32/DDK',str(trial), 'alpha.txt'), alphas, fmt='%.6f')
        np.savetxt(os.path.join('/home/gaolili/deepLearning_project/mnist_classification_32/result_32/DDK',str(trial), 'beta.txt'), betas, fmt='%.6f')
