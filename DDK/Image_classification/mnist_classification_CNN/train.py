...
if __name__ == "__main__":
    for trial in range(2,6):
                ...
                if acc_best_epoch>=0.9:
                    if input_data_MFL:
                        torch.save(model.state_dict(),
                                   '/home/gaolili/deepLearning_project/mnist_classification/ckpt_MFL/mnist_' + str(trial)+'_'+ str(
                                       acc_best_epoch) + '.pt')
                    else:
                        torch.save(model.state_dict(),
                                   '/home/gaolili/deepLearning_project/mnist_classification_CNN/ckpt/mnist_' + str(trial)+'_'+ str(
                                       acc_best_epoch) + '.pt')
        ...
        np.savetxt(os.path.join('/home/gaolili/deepLearning_project/mnist_classification_CNN/result/CNN' ,str(trial), 'accuracy.txt'), test_accuracy, fmt='%.6f')
