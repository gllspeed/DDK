import numpy as np
import os
root_path = 'D:\\deeplearning_project\\Habituation_Nural_Networks\\application3\\action_classification\\action_classification_adapt_HF_V4\\checkpoints\\hf\\loss_accuracy'
acc= []
precision = []
recall = []
f1_score = []
