...
class Net(nn.Module):
    ...
    def quantize(self, num_bits=8):
        ...
        self.qsigmoid = QSigmoid_noquantize(qo=True, num_bits=num_bits)
    ...
    def freeze(self):
        self.qfc1.freeze()
        self.qsigmoid.freeze(self.qfc1.qo)
        self.qfc.freeze(qi=self.qsigmoid.qo)
    ...
    def quantize_inference(self, x, target):
        ...
        x = self.qsigmoid.quantize_inference(x)
