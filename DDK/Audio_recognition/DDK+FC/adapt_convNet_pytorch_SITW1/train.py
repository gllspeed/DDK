...
if __name__ == "__main__":
    for trial in range(1,51):
                ...
                if acc_best_epoch>=0.9:
                    if input_data == 'DDK':
                        torch.save(model.state_dict(),
                                   '/home/gaolili/deepLearning_project/Voiceprint_20201027/adapt_convNet_pytorch_SITW1/DDK_pt_0.8train_16/adapt_speaker_DDK_' + str(trial)+'_'+str(
                                       acc_best_epoch) + '.pt')
        ...
        np.savetxt(os.path.join('/home/gaolili/deepLearning_project/Voiceprint_20201027/adapt_convNet_pytorch_SITW1/result/DDK/speaker/0.8_train_16',str(trial), 'losses_speaker.txt'), losses, fmt='%.6f')
        np.savetxt(os.path.join('/home/gaolili/deepLearning_project/Voiceprint_20201027/adapt_convNet_pytorch_SITW1/result/DDK/speaker/0.8_train_16',str(trial), 'accuracy_speaker.txt'), test_accuracy, fmt='%.6f')
        np.savetxt(os.path.join('/home/gaolili/deepLearning_project/Voiceprint_20201027/adapt_convNet_pytorch_SITW1/result/DDK/speaker/0.8_train_16',str(trial), 'precision_speaker.txt'), test_precision, fmt='%.6f')
        np.savetxt(os.path.join('/home/gaolili/deepLearning_project/Voiceprint_20201027/adapt_convNet_pytorch_SITW1/result/DDK/speaker/0.8_train_16',str(trial), 'recall_speaker.txt'), test_recall, fmt='%.6f')
        np.savetxt(os.path.join('/home/gaolili/deepLearning_project/Voiceprint_20201027/adapt_convNet_pytorch_SITW1/result/DDK/speaker/0.8_train_16',str(trial), 'f1_score_speaker.txt'), test_f1_score, fmt='%.6f')
        np.savetxt(os.path.join('/home/gaolili/deepLearning_project/Voiceprint_20201027/adapt_convNet_pytorch_SITW1/result/DDK/speaker/0.8_train_16',str(trial), 'iteration_speaker.txt'), iterations, fmt='%d')
        np.savetxt(os.path.join('/home/gaolili/deepLearning_project/Voiceprint_20201027/adapt_convNet_pytorch_SITW1/result/DDK/speaker/0.8_train_16',str(trial), 'alpha.txt'), alphas, fmt='%.6f')
        np.savetxt(os.path.join('/home/gaolili/deepLearning_project/Voiceprint_20201027/adapt_convNet_pytorch_SITW1/result/DDK/speaker/0.8_train_16',str(trial), 'beta.txt'), betas, fmt='%.6f')
