            ...
            if acc_best_epoch < accuracy[-1]:
                ...
                if acc_best_epoch>=0.8:
                        ...
                        torch.save(model.state_dict(),
                                   '/home/gaolili/deepLearning_project/Voiceprint_20201027/fft512_convNet_pytorch_speaker/pt_0.8/ckpt_' + str(trial)+'_'+ str(
                                       acc_best_epoch) + '.pt')
        if acc_best_epoch > acc_best:
            acc_best = acc_best_epoch

        np.savetxt(os.path.join(
            '/home/gaolili/deepLearning_project/Voiceprint_20201027/fft512_convNet_pytorch_speaker/result_train0.8',
