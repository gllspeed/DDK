...
def cal_flops(model):
    input = torch.randn(1, 480).to(device)
...
if __name__ == "__main__":
    for trial in range(1,6):
        ...
        seed=10
        print("i", seed)
        data_path = '/home/gaolili/deepLearning_project/Voiceprint_20201027/Input_file/WhaleSong_Raw_1Dconv.mat'
            ...
            if acc_best_epoch < accuracy[-1]:
                ...
                if acc_best_epoch>=0.9:
                        ...
                        torch.save(model.state_dict(),
                                   '/home/gaolili/deepLearning_project/Voiceprint_20201027/raw_1Dconv_pytorch_whale/pt_0.8/ckpt_' + str(trial)+'_'+ str(
                                       acc_best_epoch) + '.pt')
        if acc_best_epoch > acc_best:
            acc_best = acc_best_epoch
        np.savetxt(os.path.join(
            '/home/gaolili/deepLearning_project/Voiceprint_20201027/raw_1Dconv_pytorch_whale/result_train0.8',
